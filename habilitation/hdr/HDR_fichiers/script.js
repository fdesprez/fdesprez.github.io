...
var ENDSHOW_MESG="Fin du diaporama, cliquez pour quitter.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=44, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   ...
   new hrefList("slide0002.htm", 1, 15),
   ...
   new hrefList("slide0031.htm", 1, 26),
   new hrefList("slide0048.htm", 1, 27),
   new hrefList("slide0047.htm", 1, 28),
   new hrefList("slide0030.htm", 1, 29),
   new hrefList("slide0032.htm", 1, 30),
   new hrefList("slide0033.htm", 1, 31),
   new hrefList("slide0034.htm", 1, 32),
   new hrefList("slide0035.htm", 1, 33),
   new hrefList("slide0055.htm", 1, 34),
   new hrefList("slide0045.htm", 1, 35),
   new hrefList("slide0019.htm", 1, 36),
   new hrefList("slide0036.htm", 1, 37),
   new hrefList("slide0043.htm", 1, 38),
   new hrefList("slide0041.htm", 1, 39),
   new hrefList("slide0042.htm", 1, 40),
   new hrefList("slide0044.htm", 1, 41),
   new hrefList("slide0050.htm", 1, 42),
   new hrefList("slide0006.htm", 1, 43),
   new hrefList("slide0012.htm", 1, 44)
);
